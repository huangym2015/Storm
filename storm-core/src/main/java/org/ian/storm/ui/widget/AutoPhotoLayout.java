package org.ian.storm.ui.widget;
...
public class AutoPhotoLayout extends LinearLayoutCompat {
    ...
    private final ArrayList<List<View>> ALL_VIEWS = new ArrayList<>();
    ...
    public final void setDelegate(StormDelegate delegate) {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < lineNum; i++) {
            ...
            for (int j = 0; j < size; j++) {
                ...
                final int rc = lc + child.getMeasuredWidth() - mImageMargin; //此处要加上lc,否则加号无法显示
