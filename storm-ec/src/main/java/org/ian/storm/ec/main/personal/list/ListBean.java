...
public class ListBean implements MultiItemEntity {
    ...
    private int mId = 0;
    private StormDelegate mDelegate = null;
    private CompoundButton.OnCheckedChangeListener mOnCheckedChangeListener = null;


    public ListBean(int mItemType, String mImageUrl, String mText, String mValue, int mId, StormDelegate mDelegate, CompoundButton.OnCheckedChangeListener mOnCheckedChangeListener) {
    ...
    public static final class Builder {
        ...
        private StormDelegate delegate = null;
        ...
        public Builder setDelegate(StormDelegate delegate) {
