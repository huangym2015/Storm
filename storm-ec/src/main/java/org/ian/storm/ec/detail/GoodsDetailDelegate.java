...
import org.ian.storm.ui.animation.BezierAnimation;
import org.ian.storm.ui.animation.BezierUtil;
import org.ian.storm.ui.banner.HolderCreator;
import org.ian.storm.ui.widget.CircleTextView;
...
public class GoodsDetailDelegate extends StormDelegate implements
    ...
    private void initTabLayout(){
        ...
        mTableLayout.setSelectedTabIndicatorColor
                (ContextCompat.getColor(getContext(),R.color.app_main));
        mTableLayout.setTabTextColors(ColorStateList.valueOf(Color.BLACK));
    ...
    private void initData() {
        RestClient.builder()
                .url("JsonServlet?action=goods_detail_data_1")
                .loader(getContext())
    ...
    public void onAnimationEnd() {
        ...
        RestClient.builder()
                .url("JsonServlet?action=add_shop_cart")
                .success(new ISuccess() {
                    @Override
                    public void onSuccess(String response) {
